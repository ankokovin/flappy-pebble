    ...
    Self: Component + Sized,
{
    ...
    fn gamepad_button_pressed_system(
...
pub fn change_state_button<T>(button_bundle: ButtonBundle, component: T) -> impl Bundle
where
    T: ChangeStateButton + Bundle,
{
